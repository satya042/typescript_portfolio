...
import { Box, Link, Avatar, useTheme,Stack,styled,Paper } from "@mui/material";
...
const Home = () => {
  ...
  return (
    <Box flexDirection={{xs:"column",md:"row"}} sx={{display:'flex', justifyContent:'center',alignItems:'center',alignContent:"center",width:{xs:'100%',md:'55%'},height:{xs:20,md:400},marginLeft:{xs:0,md:'22%'},flexGrow:1 }}  >
